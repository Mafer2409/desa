        ...
        <div class="card-header">
            <form class="mx-3" action="" method="post">
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        <div class="row">
                            <!-- <a href="../assets/report/report-rt/report-pindah-rt.php?bln=<?= $bln ?>&thn=<?= $thn ?>&pin=<?= $pin ?>&idrt=<?= $idrt ?>" class="btn btn-primary ml-2 mt-5" target="_blank">Cetak</a> -->
                        </div>
                    </div>
                </div>
            </form>
...
<div class="container-xxl py-6">
    <div class="container">
        <h3 class="mb-2">Data Administrasi RW: <?= $namarw ?></h3>
