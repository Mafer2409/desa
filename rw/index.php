                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            if (isset($_POST['login'])) {
                                ...
                                $sql = mysqli_query($con, "SELECT * FROM rw WHERE rw_email = '$email' AND rw_password = '$password' AND rw_status = 'Aktif'");

                                if (mysqli_num_rows($sql) > 0) {
                                    session_start();
                                    $data = mysqli_fetch_assoc($sql);

                                    $_SESSION['id_rw'] = $data['rw_id'];
                                    $_SESSION['nama_rw'] = $data['rw_nama'];
