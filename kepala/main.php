...
if (!isset($_SESSION['id_kepala_desa'])) {
    ...
    $nama_kepala_desa = $_SESSION['nama_kepala_desa'];
}
?>
...
<head>
    ...
    <!-- Data Table -->
    <link rel="stylesheet" href="../admin/datatables/css/lib/datatable/dataTables.bootstrap.min.css">

    <!-- CKEditor -->
    <script type="text/javascript" src="../assets/ckeditor/ckeditor.js"></script>

    <!-- Chart -->
    <script type="text/javascript" src="../admin/chart/Chart.js"></script>
...
<body>
    ...
    <!-- Data Table -->
    <script src="../admin/datatables/js/lib/data-table/datatables.min.js"></script>
    <script src="../admin/datatables/js/lib/data-table/dataTables.bootstrap.min.js"></script>
    <script src="../admin/datatables/js/lib/data-table/dataTables.buttons.min.js"></script>
    <script src="../admin/datatables/js/lib/data-table/buttons.bootstrap.min.js"></script>
    <script src="../admin/datatables/js/lib/data-table/jszip.min.js"></script>
    <script src="../admin/datatables/js/lib/data-table/vfs_fonts.js"></script>
    <script src="../admin/datatables/js/lib/data-table/buttons.html5.min.js"></script>
    <script src="../admin/datatables/js/lib/data-table/buttons.print.min.js"></script>
    <script src="../admin/datatables/js/lib/data-table/buttons.colVis.min.js"></script>
    <script src="../admin/datatables/js/init/datatables-init.js"></script>
