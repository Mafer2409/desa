<?php
$id = $_GET['id'];
$sqluser = mysqli_query($con, "SELECT * FROM user, rt, rw WHERE rt.rt_rw_id = rw.rw_id AND user.user_rt_id = rt.rt_id AND user.user_id = '$id'");
        ...
        <div class="card-body">
            <table class="table table-sm table-hover">
                ...
                <tr>
                    <td>RW/RT</td>
                    <td>:</td>
                    <td>RW:<?= $datauser['rw_nama'] ?> / RT:<?= $datauser['rt'] ?></td>
                </tr>
                <tr>
                    <td>Agama</td>
                    <td>:</td>
