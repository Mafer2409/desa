...
if ($bln == '0' && $thn == '0') {
    $sql = mysqli_query($con, "SELECT * FROM user, rt, izinusaha WHERE user.user_rt_id = rt.rt_id AND user.user_id = izinusaha.izinusaha_user");
} elseif ($bln == '0' && $thn != '0') {
    $sql = mysqli_query($con, "SELECT * FROM user, rt, izinusaha WHERE user.user_rt_id = rt.rt_id AND user.user_id = izinusaha.izinusaha_user AND YEAR(izinusaha.izinusaha_tanggal_verifikasi) = '$thn'");
} else {
    $sql = mysqli_query($con, "SELECT * FROM user, rt, izinusaha WHERE user.user_rt_id = rt.rt_id AND user.user_id = izinusaha.izinusaha_user AND MONTH(izinusaha.izinusaha_tanggal_verifikasi) = '$bln' AND YEAR(izinusaha.izinusaha_tanggal_verifikasi) = '$thn'");
}
