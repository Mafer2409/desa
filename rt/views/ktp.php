<div class="container-xxl py-6">
    <div class="container">
        ...
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                $sql = mysqli_query($con, "SELECT * FROM ktp, user WHERE ktp.ktp_user = user.user_id AND ktp.ktp_rt = '$idrt' AND ktp.ktp_status = 'Menunggu Verifikasi RT'");
                $no = 1;
...
<div class="container-xxl py-6">
    <div class="container">
        ...
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                $sql = mysqli_query($con, "SELECT * FROM ktp, user WHERE ktp.ktp_user = user.user_id AND ktp.ktp_rt = '$idrt'");
                $no = 1;
                while ($data = mysqli_fetch_assoc($sql)) {
                ?>
                    <tr>
