        ...
        <div class="card-header">
            <form class="mx-3" action="" method="post">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="row">
                            <a href="../assets/report/report-rt/report-kelahiran-rt.php?bln=<?= $bln ?>&thn=<?= $thn ?>&idrt=<?= $idrt ?>" class="btn btn-primary ml-2 mt-5" target="_blank">Cetak</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="container">
        ...
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                if ($bln == 0) {
                    $sql = mysqli_query($con, "SELECT * FROM kelahiran, user WHERE kelahiran.kelahiran_user = user.user_id AND YEAR(kelahiran.kelahiran_tanggal_verifikasi) = '$thn' AND kelahiran.kelahiran_rt = '$idrt'");
                } else {
                    $sql = mysqli_query($con, "SELECT * FROM kelahiran, user WHERE kelahiran.kelahiran_user = user.user_id AND YEAR(kelahiran.kelahiran_tanggal_verifikasi) = '$thn' AND MONTH(kelahiran.kelahiran_tanggal_verifikasi) = '$bln' AND kelahiran.kelahiran_rt = '$idrt'");
                }
                $no = 1;
