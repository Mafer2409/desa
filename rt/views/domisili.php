<div class="container-xxl py-6">
    <div class="container">
        ...
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                $sql = mysqli_query($con, "SELECT * FROM domisili, user WHERE domisili.domisili_user = user.user_id AND domisili.domisili_rt = '$idrt' AND domisili.domisili_status = 'Menunggu Verifikasi RT'");
                $no = 1;
...
<div class="container-xxl py-6">
    <div class="container">
        ...
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                $sql = mysqli_query($con, "SELECT * FROM domisili, user WHERE domisili.domisili_user = user.user_id AND domisili.domisili_rt = '$idrt'");
                $no = 1;
                while ($data = mysqli_fetch_assoc($sql)) {
                ?>
                    <tr>
