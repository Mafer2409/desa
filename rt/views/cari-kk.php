    ...
    <div class="container">
        ...
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                if ($bln == 0) {
                    $sql = mysqli_query($con, "SELECT * FROM kk, user WHERE kk.kk_user = user.user_id AND YEAR(kk.kk_tanggal_verifikasi) = '$thn' AND kk.kk_rt = '$idrt'");
                } else {
                    $sql = mysqli_query($con, "SELECT * FROM kk, user WHERE kk.kk_user = user.user_id AND YEAR(kk.kk_tanggal_verifikasi) = '$thn' AND MONTH(kk.kk_tanggal_verifikasi) = '$bln' AND kk.kk_rt = '$idrt'");
                }
                $no = 1;
