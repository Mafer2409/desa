<div class="container-xxl py-6">
    <div class="container">
        ...
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                $sql = mysqli_query($con, "SELECT * FROM izinusaha, user WHERE izinusaha.izinusaha_user = user.user_id AND izinusaha.izinusaha_rt = '$idrt' AND izinusaha.izinusaha_status = 'Menunggu Verifikasi RT'");
                $no = 1;
...
<div class="container-xxl py-6">
    <div class="container">
        ...
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                $sql = mysqli_query($con, "SELECT * FROM izinusaha, user WHERE izinusaha.izinusaha_user = user.user_id AND izinusaha.izinusaha_rt = '$idrt'");
                $no = 1;
                while ($data = mysqli_fetch_assoc($sql)) {
                ?>
                    <tr>
