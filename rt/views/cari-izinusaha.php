...
<div class="container-xxl py-6">
    <div class="container">
        ...
        <h3 class="mb-2">Data Administrasi Izin usaha RT: <?= $namart ?></h3>
        <table id="bootstrap-data-table" class="table table-striped table-sm">
            ...
            <tbody>
                <?php
                if ($bln == 0) {
                    $sql = mysqli_query($con, "SELECT * FROM izinusaha, user WHERE izinusaha.izinusaha_user = user.user_id AND YEAR(izinusaha.izinusaha_tanggal_verifikasi) = '$thn' AND izinusaha.izinusaha_rt = '$idrt'");
                } else {
                    $sql = mysqli_query($con, "SELECT * FROM izinusaha, user WHERE izinusaha.izinusaha_user = user.user_id AND YEAR(izinusaha.izinusaha_tanggal_verifikasi) = '$thn' AND MONTH(izinusaha.izinusaha_tanggal_verifikasi) = '$bln' AND izinusaha.izinusaha_rt = '$idrt'");
                }
                $no = 1;
