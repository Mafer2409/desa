                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <a href="../assets/report/report-user/dom-user.php?idrt=0&s=0" class="btn btn-primary ml-2 mt-5" target="_blank">Cetak</a>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-content">
            <form action="" enctype="multipart/form-data" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <select name="user_rt_id" class="form-control">
                            <option value="">- Pilih RT -</option>
                            <?php
                            $sqlrt = mysqli_query($con, "SELECT * FROM rt");
                            while ($datart = mysqli_fetch_assoc($sqlrt)) {
