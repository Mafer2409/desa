...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3>Data warga - Penduduk Tetap | <small><?= $datart['rt'] ?></small></h3>
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <table id="bootstrap-data-table" class="table table-striped table-sm">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $sql = mysqli_query($con, "SELECT * FROM user, rt WHERE user.user_rt_id = rt.rt_id AND user.user_rt_id = '$idrt' AND user.user_status_tinggal = 'Tetap'");
