                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <a href="../assets/report/report-user/report-user.php?idrt=0&s=Tetap" class="btn btn-primary ml-2 mt-5" target="_blank">Cetak</a>
                            </div>
                        </div>
                    </div>
                </form>
                <div class="card-body table-responsive">
                    <table id="bootstrap-data-table" class="table table-striped table-sm">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $sql = mysqli_query($con, "SELECT * FROM user, rt WHERE user.user_rt_id = rt.rt_id AND user.user_status_tinggal = 'Tetap'");
