            ...
            <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <a href="../assets/report/report-admin/report-ktp.php?bln=0&thn=0" class="btn btn-primary ml-2 mt-5" target="_blank">Cetak</a>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body table-responsive">
                    <table id="bootstrap-data-table" class="table table-striped table-sm">
                        ...
                        <tbody>
                            <?php
                            $sql = mysqli_query($con, "SELECT * FROM ktp, user, rt, rw WHERE rt.rt_rw_id = rw.rw_id AND ktp.ktp_user = user.user_id AND ktp.ktp_rt = rt.rt_id");
                            $no = 1;
